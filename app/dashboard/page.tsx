...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const storedOrgType = localStorage.getItem("presentSir_orgType") as OrgType | null
    const storedUserRole = localStorage.getItem("presentSir_userRole")

    if (!storedOrgType || !storedUserRole) {
      router.push("/")
      return
    }
  ...
  const handleLogout = () => {
    localStorage.removeItem("presentSir_orgType")
    localStorage.removeItem("presentSir_userRole")
    router.push("/")
  }

  if (isLoading || !orgType || !userRole) {
    return (
